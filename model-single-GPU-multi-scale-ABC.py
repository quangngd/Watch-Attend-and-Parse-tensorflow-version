...
class Attender:
    def __init__(
        ...
        self.UC_a = tf.Variable(
            norm_weight(self.channelsB, self.dim_attend), name="UC_a"
...
class Parser:
    ...
    def one_time_step(self, past_state, inp):
        ...
        B_mask = past_state[9]
        # alpha_C
        alpha_past_B = past_state[11]
        annotation_B = past_state[12]
        B_mask = past_state[13]
