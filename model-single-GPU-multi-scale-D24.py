...
class Watcher_train:
    ...
    def dense_net(self, input_x, mask_x):
        ...
        return dense_out, mask_x, B_out, B_mask
...
class Parser:
    def __init__(self, hidden_dim, word_dim, attender, contextA_dim, contextB_dim):
...
def main(args):
    ...
    B_option = {"branch_from": 1, "growth_rate": 24, "level":12 }  # D/2
